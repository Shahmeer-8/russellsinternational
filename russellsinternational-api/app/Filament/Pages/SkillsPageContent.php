        ...
        return [
            [
                ...
                'sections' => [
                    ...
                    $this->pageSection('Courses heading and tabs', 'Eyebrow, heading and intro above the courses, plus the two tab labels and the NAVTTC badge (the tab_1, tab_2 and tab_3 rows).', 'skills', 'courses'),
