...
class SectionHeadingSeeder extends Seeder
{
    ...
    private function headings(): array
    {
        return [
            ...
            [
                'page_slug' => 'careers',
                'section_key' => 'internships_paid',
                'name' => 'Careers — Paid internships group heading',
                'eyebrow' => 'Open now',
                'title' => 'Paid Internships',
                'subtitle' => 'Year-round placements with a stipend or salary, working on live projects alongside our team.',
            ],
            [
                'page_slug' => 'careers',
                'section_key' => 'internships_summer',
                'name' => 'Careers — Summer programmes group heading',
                'eyebrow' => 'Summer programmes',
                'title' => 'Summer Internship Programs',
                'subtitle' => 'Short, intensive cohorts that run over the summer break — built for students who want real project experience before their final year.',
            ],
            [
                'page_slug' => 'careers',
                'section_key' => 'internship_record',
                'name' => 'Careers — Internship record heading',
                'eyebrow' => 'Our track record',
                'title' => 'Internship Record',
                'subtitle' => 'Programmes we have already run, the people who took part and what they went on to achieve.',
            ],
            [
                'page_slug' => 'events',
                'section_key' => 'news',
