    ...
    <section id="testimonials" className="py-20 md:py-28">
      ...
      >
        <div className="max-w-2xl mb-14">
          ...
          <p className="text-muted-foreground mt-4 max-w-lg">{videoList.length > 0 ? "Watch and read how our students transformed their futures with us." : "Read how our students transformed their futures with us."}</p>
        </div>
