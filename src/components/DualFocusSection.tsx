      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="premium-card overflow-hidden">
          <div className="h-52 overflow-hidden">
            <img src={skillImg} alt="Students in coding lab" className="w-full h-full object-cover" loading="lazy" width={960} height={640} />
          </div>
          <div className="p-7">
            ...
            <div className="space-y-3">
              {courses.map((c) => (
                <div key={c.title} className="flex items-center gap-3 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
        ...
        <div className="premium-card overflow-hidden">
          <div className="h-52 overflow-hidden">
            <img src={abroadImg} alt="Student heading to university" className="w-full h-full object-cover" loading="lazy" width={960} height={640} />
          </div>
          <div className="p-7">
            ...
            <div className="space-y-3">
              {countries.map((c) => (
                <div key={c.name} className="flex items-center gap-3 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
            ...
            <a href="#destinations" className="btn-cta inline-flex items-center gap-2 mt-6 text-sm px-5 py-2.5 group">
